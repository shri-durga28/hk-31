...
const generateTrafficData = () => {
  return [
    { zone: 'Main Entrance', people: Math.floor(Math.random() * 50) + 10, lat: 12.9487, lng: 80.1379 },
    { zone: 'Sanctum', people: Math.floor(Math.random() * 70) + 30, lat: 12.9486, lng: 80.1375 },
    { zone: 'Inner Hall', people: Math.floor(Math.random() * 80) + 20, lat: 12.9483, lng: 80.1374 },
    { zone: 'Outer Courtyard', people: Math.floor(Math.random() * 40) + 5, lat: 12.9482, lng: 80.1372 },
  ];
};
  ...
  return (
    <div className="w-full p-4 rounded-lg shadow-lg bg-gradient-to-r from-gray-200 via-gray-100 to-gray-200">
      ...
      <div className="mt-4 text-sm text-center text-gray-600">
        <p>Zones update every 5 seconds to reflect real-time visitor traffic density.</p>
        <p>Heatmap shows areas of higher density (red for high traffic, green for low traffic).</p>
      </div>
    </div>
  );
};
