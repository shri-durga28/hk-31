...
const features = [
  { position: [12.9482, 80.1379], label: 'ಪ್ರವೇಶ ದ್ವಾರ' }, // Entrance
  { position: [12.9483, 80.1377], label: 'ಮುಖ್ಯ ಹಾಲ್' }, // Main Hall
  { position: [12.9481, 80.1376], label: 'ಆಂಗಣ' } // Courtyard
];

const CustomTempleMapKn = () => {
  return (
...
export default CustomTempleMapKn;
