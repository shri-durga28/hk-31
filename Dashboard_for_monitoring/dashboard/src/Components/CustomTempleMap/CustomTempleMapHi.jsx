...
const features = [
  { position: [12.9482, 80.1379], label: 'प्रवेश द्वार' }, // Entrance
  { position: [12.9483, 80.1377], label: 'मुख्य हॉल' }, // Main Hall
  { position: [12.9481, 80.1376], label: 'आंगन' } // Courtyard
];

const CustomTempleMapHi = () => {
  return (
...
export default CustomTempleMapHi;
