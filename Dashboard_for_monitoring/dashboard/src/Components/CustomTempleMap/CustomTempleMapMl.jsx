...
const features = [
  { position: [12.9482, 80.1379], label: 'പ്രവേശം' }, // Entrance
  { position: [12.9483, 80.1377], label: 'പ്രധാന ഹാൾ' }, // Main Hall
  { position: [12.9481, 80.1376], label: 'കൂട്ടമണ്ഡപം' } // Courtyard
];

const CustomTempleMapMl = () => {
  return (
...
export default CustomTempleMapMl;
