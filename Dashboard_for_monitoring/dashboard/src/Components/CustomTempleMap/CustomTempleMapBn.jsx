...
const features = [
  { position: [12.9482, 80.1379], label: 'প্রবেশদ্বার' }, // Entrance
  { position: [12.9483, 80.1377], label: 'মুখ্য হল' }, // Main Hall
  { position: [12.9481, 80.1376], label: 'আঙিনা' } // Courtyard
];

const CustomTempleMapBn = () => {
  return (
...
export default CustomTempleMapBn;
