...
const features = [
  { position: [12.9482, 80.1379], label: 'પ્રવેશદ્વાર' }, // Entrance
  { position: [12.9483, 80.1377], label: 'મુખ્ય હોલ' }, // Main Hall
  { position: [12.9481, 80.1376], label: 'આંગણ' } // Courtyard
];

const CustomTempleMapGu = () => {
  return (
...
export default CustomTempleMapGu;
