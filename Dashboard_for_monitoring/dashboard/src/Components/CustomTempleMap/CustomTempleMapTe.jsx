...
const features = [
  { position: [12.9482, 80.1379], label: 'ప్రవేశం' }, // Entrance
  { position: [12.9483, 80.1377], label: 'ముఖ్య హాల్' }, // Main Hall
  { position: [12.9481, 80.1376], label: 'ఆవరణ' } // Courtyard
];

const CustomTempleMapTe = () => {
  return (
...
export default CustomTempleMapTe;
