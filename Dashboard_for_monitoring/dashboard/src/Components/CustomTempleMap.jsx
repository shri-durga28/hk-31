...
const features = [
  { position: [12.9482, 80.1379], label: 'Entrance' },
  { position: [12.9483, 80.1377], label: 'Main Hall' },
  { position: [12.9481, 80.1376], label: 'Courtyard' }
];

const CustomTempleMap = () => {
  return (
...
export default CustomTempleMap;
